-- First, update the check constraint to allow pharmacy role
ALTER TABLE profiles DROP CONSTRAINT IF EXISTS profiles_role_check;

-- Add the new check constraint including pharmacy role
ALTER TABLE profiles ADD CONSTRAINT profiles_role_check 
CHECK (role IN ('nurse', 'doctor', 'finance', 'admin', 'pharmacy'));

-- Now update the pharmacy user role
UPDATE profiles 
SET role = 'pharmacy' 
