...
export const DoctorNoteDialog = ({ open, onOpenChange, admissionId, patientId, onSuccess }: DoctorNoteDialogProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Doctor note created successfully",
      ...
      toast({
        title: "Error",
        description: "Failed to create doctor note. Please try again.",
        variant: "destructive",
      });
    } finally {
      setLoading(false);
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          <DialogTitle>Create Doctor Note</DialogTitle>
        </DialogHeader>
